...
namespace OjstrMessage\MessageBundle\Component\Dispatcher;
...
final class MessageEvents
{
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageEvent instance.
     */
    const USER_MESSAGE_CREATE_INITIALISE = 'ojstr_message.user.message.create.initialise';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageEvent instance.
     */
    const USER_MESSAGE_CREATE_SUCCESS = 'ojstr_message.user.message.create.success';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageEvent instance.
     */
    const USER_MESSAGE_CREATE_COMPLETE = 'ojstr_message.user.message.create.complete';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageResponseEvent instance.
     */
    const USER_MESSAGE_CREATE_RESPONSE = 'ojstr_message.user.message.create.response';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageFloodEvent instance.
     */
    const USER_MESSAGE_CREATE_FLOODED = 'ojstr_message.user.message.create.flooded';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageEvent instance.
     */
    const USER_MESSAGE_CREATE_REPLY_INITIALISE = 'ojstr_message.user.message.create_reply.initialise';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageEvent instance.
     */
    const USER_MESSAGE_CREATE_REPLY_SUCCESS = 'ojstr_message.user.message.create_reply.success';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageEvent instance.
     */
    const USER_MESSAGE_CREATE_REPLY_COMPLETE = 'ojstr_message.user.message.create_reply.complete';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageResponseEvent instance.
     */
    const USER_MESSAGE_CREATE_REPLY_RESPONSE = 'ojstr_message.user.message.create_reply.response';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageFloodEvent instance.
     */
    const USER_MESSAGE_CREATE_REPLY_FLOODED = 'ojstr_message.user.message.create_reply.flooded';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageEvent instance.
     */
    const USER_MESSAGE_CREATE_FORWARD_INITIALISE = 'ojstr_message.user.message.create_forward.initialise';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageEvent instance.
     */
    const USER_MESSAGE_CREATE_FORWARD_SUCCESS = 'ojstr_message.user.message.create_forward.success';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageEvent instance.
     */
    const USER_MESSAGE_CREATE_FORWARD_COMPLETE = 'ojstr_message.user.message.create_forward.complete';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageResponseEvent instance.
     */
    const USER_MESSAGE_CREATE_FORWARD_RESPONSE = 'ojstr_message.user.message.create_forward.response';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageFloodEvent instance.
     */
    const USER_MESSAGE_CREATE_FORWARD_FLOODED = 'ojstr_message.user.message.create_forward.flooded';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserEnvelopeReceiveEvent instance.
     */
    const USER_ENVELOPE_RECEIVE_COMPLETE = 'ojstr_message.user.envelope.receive.complete';
     ...
     *
     * This event allows you to modify the request object and set a flash message.
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserEnvelopeReceiveFailedInboxFullEvent instance.
     */
    const USER_ENVELOPE_RECEIVE_FAILED_INBOX_FULL = 'ojstr_message.user.envelope.receive.failed.inbox_full';
    /**
     *
     ...
     *
     * This event allows you to modify the request object and set a flash message.
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserEnvelopeReceiveFailedOutboxFullEvent instance.
     */
    const USER_ENVELOPE_RECEIVE_FAILED_OUTBOX_FULL = 'ojstr_message.user.envelope.receive.failed.outbox_full';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageResponseEvent instance.
     */
    const USER_MESSAGE_DRAFT_SEND_RESPONSE = 'ojstr_message.user.message.draft_send.response';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageResponseEvent instance.
     */
    const USER_MESSAGE_MARK_AS_READ_RESPONSE = 'ojstr_message.user.message.mark_as_unread.response';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageResponseEvent instance.
     */
    const USER_MESSAGE_MARK_AS_UNREAD_RESPONSE = 'ojstr_message.user.message.mark_as_unread.response';
     ...
     * The event listener method receives a OjstrMessage\MessageBundle\Component\Dispatcher\Event\UserMessageResponseEvent instance.
     */
    const USER_MESSAGE_DELETE_RESPONSE = 'ojstr_message.user.message.delete.response';
}
